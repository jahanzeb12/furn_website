...
SECRET_KEY = 'kw-2r)o1vl&7a&friofha$6rgy%-!xbf%m1xbh#k*34v7vlh(7'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR /'templates/furnapp' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'webfurniture8@gmail.com'
# EMAIL_HOST_PASSWORD = 'jahanzeb1'